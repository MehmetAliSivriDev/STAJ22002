...
<head>
    ...
    <title>Barkod Taratma Sipariş Yönlendirici</title>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <a type="button" href="/kartelaweb/view/barcode_scanner.php" class="btn-custom btn btn-primary mb-3 p-2 text-white" >Taratmaya Devam Et <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-upc-scan" viewBox="0 0 18 18">
