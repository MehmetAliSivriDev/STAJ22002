<?php
  session_start();
  $_SESSION['PAGE'] = "MAKE_NEW_SALE_BARCODE_SCAN";
...
<body>
    ...
    <div class="d-flex flex-column align-items-center card mx-2 shadow">
        <div class="card-body">
            ...
            <form id="barcode_scanner_id" action="/stokweb/backend/scan_and_add_sale_item.php" method="POST">
                <div class="row mb-3">
                    <input type="text" class="form-control" id="barcode" name="barcode" placeholder="Okunan Barkod" required>
                    <p id="status"></p>
                </div>
                ...
                <div class="row mb-3">
                    <a type="button" href="javascript:window.history.go(-1)" class="btn btn-warning mb-3 p-2 text-white" ><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-caret-left-fill" viewBox="0 0 18 18">
    ...
    <script>
        ...
        function onScanSuccess(decodedText, decodedResult) {
            if(isFormSubmitted == false){
                ...
                document.getElementById('barcode_scanner_id').submit();
