...
<body>
    ...
    <div class="d-flex flex-column align-items-center card mx-2 shadow">
        <div class="card-body">
            ...
            <form id="barcode_scanner_id" action="/stokweb/view/stock_enter_barcode.php" method="get">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <a type="button" href="/stokweb/view/stock_enter_type.php" class="btn btn-warning mb-3 p-2 text-white" ><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-caret-left-fill" viewBox="0 0 18 18">
